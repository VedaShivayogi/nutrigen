...
import { IoNutritionOutline, IoHeartOutline, IoSparklesOutline } from 'react-icons/io5';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-1.5 text-gray-400 text-sm mt-4 md:mt-0">
            <span>Made with</span>
            <IoHeartOutline className="h-4 w-4 text-red-500 animate-pulse" />
            <span>by</span>
            <span className="font-semibold text-white flex items-center gap-1 hover:text-primary transition-colors duration-200">
              Veda
              <IoSparklesOutline className="h-4 w-4 text-yellow-400" />
            </span>
          </div>
        </div>
      </div>
